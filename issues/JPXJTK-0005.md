---
title: `git issue status` and etc. do not reflect remote immediately
type: bug
priority: P1
status: open
---
...
`git issue status` does not actively reflect the remote's status.
...
something like `git issue status --remote`
